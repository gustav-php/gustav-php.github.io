...
These are input contracts: Gustav hydrates them from client data and reports conversion failures as `422` responses. Output DTOs returned with `#[JsonResponse]` use a separate serialization contract; see [Serialization](./serialization.md).
